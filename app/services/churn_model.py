...
class ChurnModelTrainer:
    ...
    def load(self, filename: str = 'churn_model.pkl') -> None:
        ...
        try:
            ...
            required_keys = ['model', 'scaler', 'label_encoders', 'feature_names', 'metrics']
            missing_keys = [key for key in required_keys if key not in model_data]
            
            if missing_keys:
                raise RuntimeError(f"Corrupted model file. Missing keys: {missing_keys}")
    ...
    def get_model_info(self) -> Dict[str, any]:
        ...
        return {
            ...
            "feature_names": self.feature_names,
            "metrics": self.metrics,
            "class_weights": dict(self.model.class_weight) if hasattr(self.model, 'class_weight') else None
        }
