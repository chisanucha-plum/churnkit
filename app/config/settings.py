...
class Settings(BaseSettings):
    ...
    app_name: str = Field(
        default="Customer Churn Prediction System",
    ...
    best_model_name: str = Field(
        default="lightgbm_model.pkl",
        description="Best model filename"
    )
    ...
    llm_provider: str = Field(
        default="openrouter",
        description="LLM provider (openrouter, gemini, ollama)"
    )
    ...
    enable_batch_prediction: bool = Field(
        default=True,
        description="Enable batch prediction"
    )
    ...
    enable_llm_insights: bool = Field(
        default=True,
        description="Enable LLM insights"
    )
    ...
    def get_database_url(self) -> str:
        ...
        """
        if self.database_url and self.database_url != "postgresql://user:password@localhost:5432/churn_db":
